  ...
  const fetchData = async () => {
    try {
      ...
      setFormData({
        ...
        state: custodianData.state || '',
        zipCode: custodianData.zipCode || ''
      });
    } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || 'Failed to update custodian');
      }
    ...
    <Layout>
      <div className="p-6 max-w-2xl mx-auto">
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Edit Custodian</h1>
        </div>
