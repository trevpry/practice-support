...
const EditWorkspace = () => {
  ...
  const fetchInitialData = async () => {
    try {
      ...
      const [workspaceData, mattersData, orgsData, typeData] = await Promise.all([
        workspaceRes.json(),
        mattersRes.json(),
        orgsRes.json(),
        typeRes.json()
      ...
      setFormData({
        ...
        matterId: workspaceData.matterId.toString(),
        organizationId: workspaceData.organizationId.toString()
      });
      ...
      setErrors({ submit: 'Failed to load workspace data. Please refresh the page.' });
    } finally {
